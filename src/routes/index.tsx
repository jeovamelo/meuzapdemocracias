...
- Tabela rica e interativa with busca, filtros por zona/bairro e paginação.
...
- Gestão de Materiais with categorias (Ex: Santinhos, Adesivos, Bandeiras, Vestuário).
...
- Construído with React, Tailwind CSS, Lucide Icons e componentes modernos.

- Gráficos fluidos e responsivos (utilizando bibliotecas como Recharts).

- Simulação de banco de dados robusta with dados fictícios realistas do Ceará (Fortaleza, Caucaia, Juazeiro do Norte, Sobral, Maracanaú, etc.) para testes imediatos.
        </span>
      </div>
